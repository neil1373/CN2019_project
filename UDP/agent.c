...
int main(int argc, char* argv[]){
    ...
    int n = recvfrom(agentsocket, &s_tmp, sizeof(s_tmp), 0, (struct sockaddr *)&sender, &sender_size);
    sendto(agentsocket, &s_tmp, sizeof(s_tmp), 0, (struct sockaddr *)&receiver, recv_size);
    recvfrom(agentsocket, &s_tmp, sizeof(s_tmp), 0, (struct sockaddr *)&receiver, &recv_size);
    sendto(agentsocket, &s_tmp, sizeof(s_tmp), 0, (struct sockaddr *)&sender, sender_size);
